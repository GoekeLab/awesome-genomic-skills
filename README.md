...
- [Folklore Clinical Variant Interpretation MCP](https://github.com/helena-bioinformatics/folklore-mcp) - Helena Bioinformatics MCP for clinical variant interpretation, ACMG/AMP evidence and literature. Provides four read-only tools for supported GRCh38 germline nuclear SNVs and simple indels, variant-focused literature and semantic search across the public Literature Corpus with PMID, DOI and PMCID anchors. Results retain provenance and professional-review limitations. The hosted endpoint requires no authentication; it accepts no patient or case context and does not provide a diagnosis. [Website](https://folklore.helena.bio) · [Official Registry](https://registry.modelcontextprotocol.io/?q=io.github.helena-bioinformatics%2Ffolklore) · [DOI](https://doi.org/10.5281/zenodo.21922951)
