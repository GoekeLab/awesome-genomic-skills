...
- [SeqBench](https://seqbench.com/api/mcp) - Hosted MCP server exposing molecular biology and cloning tools (primer design, cloning simulation, CRISPR guide design, batch processing) to AI agents. Also listed on the official MCP Registry as `com.seqbench/workbench`.
