...
- [Spraay x402 MCP](https://smithery.ai/servers/Plagtech/Spraay-x402-mcp) - x402 payment gateway with 161 MCP tools including PubMed (36M papers, search/PMID/related), PubChem (compound/similarity/bioactivity), and OpenAlex (250M papers). AI agents pay per call in USDC — no API keys.
