...
- [Folklore Clinical Variant Interpretation MCP](https://github.com/helena-bioinformatics/folklore-mcp) - Helena Bioinformatics MCP 1.5.0 for genomic variant interpretation, ClinGen gene-disease evidence and literature. Six scientific read-only tools cover supported GRCh38 germline variants, gene-to-disease and disease-to-gene assertions with inheritance and source provenance, and source-linked literature; a seventh optional tool discovers Helena Good support. Results retain provenance and professional-review limitations. The hosted endpoint requires no authentication; it accepts no patient or case context and does not provide a diagnosis. [Website](https://folklore.helena.bio) · [Official Registry](https://registry.modelcontextprotocol.io/?q=io.github.helena-bioinformatics%2Ffolklore) · [DOI](https://doi.org/10.5281/zenodo.21922951)
